...
PICS = (environ.get('PICS', 'https://i.ibb.co/S4MdDrcr/Screenshot-20260802-125543.jpg.jpg https://graph.org/file/5303692652d91d52180c2.jpg https://graph.org/file/425b6f46efc7c6d64105f.jpg https://graph.org/file/876867e761c6c7a29855b.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8108479890').split()] # Replace with the actual admin ID(s) to add
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004482937411'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1004287747467'))  # Bin channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1004304042089')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-100')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1004304042089')  # Support group link (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://t78014656_db_user:<db_password>@cluster1.dpgzd9i.mongodb.net/?appName=Cluster1")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster1") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'hackflix') # Collection name (default: dreamcinezone_files)

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "False"), False) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://sahnwaja109_db_user:<db_password>@cluster2.kujztjv.mongodb.net/?appName=Cluster2")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
DATABASE_NAME = environ.get('DATABASE_NAME', "hackflix_01") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'hackflix_01') # Collection name (default: dreamcinezone_files
# ============================
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Hackflix007")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Hackflix007")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Hackflix007")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/xygkgg') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 't.me/Hackflix007') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Hackflix07') # Update channel link for the bot
